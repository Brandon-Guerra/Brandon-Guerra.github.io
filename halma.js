...
var audio = new Audio("SpongebobJellyfishJam.mp3");
...
function drawPiece(p, selected) {
    ...
    gDrawingContext.stroke();
    if(row < 3 && column > 5){
        gDrawingContext.strokeStyle = "#00CF00";
        gDrawingContext.stroke();
        gDrawingContext.fillStyle = "#00CF00";
...
function partyTime(){
    ...
    setInterval(function(){
        ranOne = Math.floor((Math.random() * 255) + 1);
        fontC1 = 255 - ranOne;
        ranTwo = Math.floor((Math.random() * 255) + 1);
        fontC2 = 255 - ranTwo;
        ranThree = Math.floor((Math.random() * 255) + 1);
        fontC3 = 255 - ranThree;
        document.body.style.backgroundColor="rgb(" + ranOne + "," + ranTwo + "," + ranThree + ")";
    }, 100);
